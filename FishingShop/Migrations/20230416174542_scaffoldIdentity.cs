    ...
    public partial class scaffoldIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Shop", x => x.id_point);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    paydata = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    id_user = table.Column<int>(type: "int", nullable: false),
                    deliverypoint = table.Column<int>(type: "int", nullable: false),
                    date = table.Column<DateTime>(type: "date", nullable: false),
                    status = table.Column<int>(type: "int", nullable: false),
                    UserOldIdUser = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Order", x => x.id_order);
                    table.ForeignKey(
                        name: "FK_Order_DeliveryPoint",
                        column: x => x.deliverypoint,
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Order_User_UserOldIdUser",
                        column: x => x.UserOldIdUser,
                        principalTable: "User",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id_orderitem = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Order_deliverypoint",
                table: "Order",
                column: "deliverypoint");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Order_UserOldIdUser",
                table: "Order",
                column: "UserOldIdUser");
